...
owner_name = 'Seah Boon Lock' # String
...
common_allergens = ['dairy', 'soy', 'tree nuts'] # List
tax_rate = 0.12 # Float

# Displaying Variables
display(f'Try our best-seller for only P{popular_item_price}!', target='popular')
...
if has_delivery:
   display(f"Accepting delivery orders through the CHICHA San Chen app!", target='delivery')